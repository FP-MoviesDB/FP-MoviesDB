...
?>
        ...
        <div class="fp__post_info_wrapper">
            <!-- <div style="width: 100%;"> -->
            <h2 class="fp__post_info_heading"><?php echo $postInfo_title ?></h2>
            ...
            <?php if (!empty($meta_data['fp_title'])): ?>
                <li class="fp__post_info_li"><span class='fp__post_info_li_name'>Name</span><span class="fp__post_info_colon">:</span><span class="fp__post_info_span">
                    <?php echo $meta_data['fp_title'] ?>
                    <!-- release_year -->
                    <?php if (!empty($meta_data['fp_oldest_year'])) : ?>
                        <span class="fp__post_info_span__year"> (<?php echo $meta_data['fp_oldest_year'] ?>)</span>
                    <?php endif; ?>
                </span></li>
            <?php endif; ?>
            <?php if (!empty($meta_data['fp_post_type_upper'])): ?>
                <li class="fp__post_info_li"><span class='fp__post_info_li_name'>Type</span><span class="fp__post_info_colon">:</span><span class="fp__post_info_span"><?php echo $meta_data['fp_post_type_upper'] ?></span></li>
            <?php endif; ?>
            <?php if (!empty($meta_data['fp_years'])): ?>
                <li class="fp__post_info_li"><span class='fp__post_info_li_name'>Year</span><span class="fp__post_info_colon">:</span><span class="fp__post_info_span"><?php echo $meta_data['fp_years'] ?></span></li>
            <?php endif; ?>
            <?php if (!empty($meta_data['fp_network'])): ?>
                <li class="fp__post_info_li"><span class='fp__post_info_li_name'>Network</span><span class="fp__post_info_colon">:</span><span class="fp__post_info_span"><?php echo $meta_data['fp_network'] ?></span></li>
            <?php endif; ?>
            <?php if (!empty($meta_data['fp_default_language'])): ?>
                <li class="fp__post_info_li"><span class='fp__post_info_li_name'> Audio</span><span class="fp__post_info_colon">:</span><span class="fp__post_info_span"><?php echo $meta_data['fp_default_language'] ?> <span style="color: #32bb00; font-weight: 500;"><?php echo $meta_data['fp_language_extend'] ?></span></span> </li>
            <?php endif; ?>
            <?php if (!empty($meta_data['fp_subtitles_count_customValue_2'])): ?>
                <li class="fp__post_info_li"><span class='fp__post_info_li_name'> Subtitle</span><span class="fp__post_info_colon">:</span><span><?php echo $meta_data['fp_subtitles_count_customValue_2'] ?></span> </li>
            <?php endif; ?>
            <?php if (!empty($sizes)): ?>
                <li class="fp__post_info_li"> <span class='fp__post_info_li_name'>Size</span> <span class="fp__post_info_colon">:</span> <span class="fp__post_info_span"> <span class="fp__post_info_span__size"><?php echo $sizes ?> </span> </span> </li>
            <?php endif; ?>
            <?php if (!empty($resolutions)): ?>
                <li class="fp__post_info_li"><span class='fp__post_info_li_name'>Quality</span><span class="fp__post_info_colon">:</span><span class="fp__post_info_span"><?php echo $resolutions ?>
                <?php if (!empty($meta_data['fp_quality'])) : ?>
                <span class="fp__post_info_span__quality"><?php echo "  -->  " . $meta_data['fp_quality'] ?></span>
                <?php endif; ?>
            </span></li>
            <?php endif; ?>
                ...
                <?php if ($meta_data['fp_imdb']) : ?>
                    <li class="fp__post_info_li fp__post_info_li_imdb">
                        <div class="fp__post_info_li_imdb_link"><a href="<?= FP_MOVIES_IMDB_BASE_URL . '/' . $meta_data['fp_imdb'] ?>" target="_blank">
                            <span style="display: inline-flex; align-items: center; justify-content: center;">
                                <!-- <i class="fab fa-imdb fp_info_imdb_icon"></i> -->
                                 <!-- USE LOCAL SVG IMAGE -->
                                  <img class="fp_info_imdb_icon imdb_icon_pc" src="<?php echo FP_MOVIES_URL . 'img/imdb_light.svg' ?>" alt="IMDb" width="25" height="auto">

                                  <img class="fp_info_imdb_icon imdb_icon_mobile" src="<?php echo FP_MOVIES_URL . 'img/imdb_dark.svg' ?>" alt="IMDb" width="30" height="auto">
                            </span><span class="fp_info_imdb_link">IMDb Rating:- <?php echo $meta_data['fp_vote_average'] ?>/10</span></a></div>
                    </li>
                <?php endif; ?>
            </ul>
            <!-- </div> -->
