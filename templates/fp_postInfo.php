            ...
            <ul class="fp__post_info_grid">
                ...
                <?php if ($meta_data['fp_imdb']) : ?>
                    <li class="fp__post_info_li fp__post_info_li_imdb">
                        <span class='fp__post_info_li_name'>IMDb Rating</span>
                        <span class="fp__post_info_colon">:</span>
                        <span class="fp__post_info_li_imdb_link"><a href="<?php echo esc_url(FP_MOVIES_IMDB_BASE_URL . '/' . esc_attr($meta_data['fp_imdb'])); ?>" target="_blank">
                                <span style="display: inline-flex; align-items: center; justify-content: center;">
                                    <img class="fp_info_imdb_icon imdb_icon_pc" src="<?php echo esc_html(esc_url(FP_MOVIES_URL) . 'img/imdb-v2.svg') ?>" alt="IMDb" width="30" height="auto">

                                    <img class="fp_info_imdb_icon imdb_icon_mobile" src="<?php echo esc_html(esc_url(FP_MOVIES_URL) . 'img/imdb_dark.svg') ?>" alt="IMDb" width="25" height="auto">
                                </span>
                                <span class="fp_info_imdb_link"><?php echo esc_html($meta_data['fp_vote_average']) ?>/10</span>
                                <img class="fp_info_imdb_icon imdb_icon_pc" src="<?php echo esc_html(esc_url(FP_MOVIES_URL) . 'img/star-yellow.svg') ?>" alt="IMDb" width="20" height="auto">

                                <img class="fp_info_imdb_icon imdb_icon_mobile" src="<?php echo esc_html(esc_url(FP_MOVIES_URL) . 'img/star-dark.svg') ?>" alt="IMDb" width="20" height="auto">
                            </a>
                        </span>
                    </li>
                <?php endif; ?>
